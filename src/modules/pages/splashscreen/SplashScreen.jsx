...
export default function SplashScreen({onDone}){
    ...
    return(
        <div style={{display: (isClicked) ? 'none' : 'flex' }} className='flex flex-col h-screen w-screen justify-center items-center z-[999] font-saira '>
            ...
            <Link to ='/home'>
            <button className='m-6 p-4 text-center border-1 rounded-2xl' onClick={handleClick}> View More </button>
            </Link>
        </div>
    )
}
