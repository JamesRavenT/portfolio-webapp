...
export default function DesktopView({ images, currentProject, currentIndex, setCurrentIndex }) {
  return (
    <div className="hidden md:flex flex-col items-center h-[100vh] w-full pt-25 gap-y-3 font-electrolize">
      ...
      <div className="flex h-[80vh] w-[44rem] translate-y-[4%] translate-x-[50%] absolute">
