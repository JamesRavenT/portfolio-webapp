...
export default function DesktopView({ index, direction, setIndex }) {
  return (
    <div className="hidden lg:flex w-full mt-25">
      <div className="flex w-[35%]" />
      <div className="flex flex-col w-full items-center justify-center mx-10 pt-5">
        <Fortes index={index} direction={direction} setIndex={setIndex} />
        <Techstack index={index} setIndex={setIndex} />
      </div>
      <div className="flex w-[35%] justify-center items-center"></div>
    </div>
  );
}
